...
class IntroState(GameState):
    def __init__(self, screen, audio_manager=None):
        ...
        # No story text in scene 1 anymore - text moved to scene 0
        self.text_visible = False
        self.story_finished = True
        self.movement_locked = False  # Movement unlocked from start
    ...
    def load_background(self):
        ...
        try:
            project_root = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            bg_path = os.path.join(project_root, "assets", "images", "backgrounds", "scene1", "forest_path.png")
    ...
    def update(self, dt):
        ...
        # Handle movement (no text delays in scene 1)
    ...
    def render(self, screen):
        ...
        # No story text in scene 1 - moved to scene 0


        # Draw scene number
        scene_font = pygame.font.Font(None, 36)
        scene_text = scene_font.render("SCENE 1", True, (255, 255, 255))
        ...
        # Draw instructions
        instructions = "Walk north to Maginot Line • SPACE Toggle audio • C Debug • ESC Quit"
